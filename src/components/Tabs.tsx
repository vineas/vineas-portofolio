            ...
            <div className='justify-center min-h-screen'>
                <ul className="mx-auto grid max-w-full w-full grid-cols-3 gap-x-5 px-8">
                    ...
                    <li className="">
                        ...
                        <div className="absolute  left-0 p-6 mt-2 border-indigo-300 rounded-lg w-[97vw] mx-auto transition-all duration-500 ease-in-out opacity-0 invisible peer-checked:opacity-100 peer-checked:visible peer-checked:translate-x-1">
                            <Contact />
                        </div>
                    </li>
                </ul>
